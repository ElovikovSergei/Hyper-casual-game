...
namespace Tween
{
    public abstract class TweenCase
    {
        ...
        public TweenController.TweenCallback onCompleteCallback;
        ...
        {
            TweenController.AddTween(this, tweenType);
        ...
        public TweenCase Kill()
        {
            if (!isKilling)
            {
                ...
                TweenController.MarkForKilling(this);
        ...
        public TweenCase OnComplete(TweenController.TweenCallback callback)
        {
    ...
    {
        private TweenController.TweenCallback callback;
        protected int resultFrame;
        protected int framesOffset;

        public TweenCaseNextFrame(TweenController.TweenCallback callback, int framesOffset)
        {
            this.callback = callback;
    ...
    {
        public TweenCaseUpdateNextFrame(TweenController.TweenCallback callback, int framesOffset) : base(callback, framesOffset)
        {
        ...
        {
            resultFrame = TweenController.UpdateFramesCount + framesOffset;
        ...
        {
            return resultFrame <= TweenController.UpdateFramesCount;
        }
    }

    public sealed class TweenCaseFixedUpdateNextFrame : TweenCaseNextFrame
    {
        public TweenCaseFixedUpdateNextFrame(TweenController.TweenCallback callback, int framesOffset) : base(callback, framesOffset)
        {
        ...
        public override TweenCase StartTween()
        {
            resultFrame = TweenController.FixedUpdateFramesCount + framesOffset;
        ...
        public override bool CheckFrameState()
        {
            return resultFrame <= TweenController.FixedUpdateFramesCount;
        }
    }

    public sealed class TweenCaseLateUpdateNextFrame : TweenCaseNextFrame
    {
        public TweenCaseLateUpdateNextFrame(TweenController.TweenCallback callback, int framesOffset) : base(callback, framesOffset)
        {
        ...
        public override TweenCase StartTween()
        {
            resultFrame = TweenController.LateUpdateFramesCount + framesOffset;
        ...
        public override bool CheckFrameState()
        {
            return resultFrame <= TweenController.LateUpdateFramesCount;
        }
    }
